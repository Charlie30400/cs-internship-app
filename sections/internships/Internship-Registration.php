...
<head>
    ...
    <meta name="description" content="Internship Registration">
    <meta name="keywords" content="Internship-App,Internship Registration">
...
require '../../config/functions/Select.php';
?>
            ...
            <div class="col-lg-6 m-auto">
                <div class="card mt-5">
                    <div class="card-header">
                        <h2 class="frm-Title"> Create Internship</h2>
                        <div class="icon">
                    ...
                    <div class="card-body">
                        <form method="POST" action="../../config/edit/send/send-internship-data.php">
                            <select name="student" class="form-control md-2">
                                <?php echo SelectStudents($conn); ?>
                            </select><br>
                            <select name="company" class="form-control md-2">
                                <?php echo SelectCompany($conn); ?>
                            </select><br>
                            <select name="department" class="form-control md-2">
                                <?php echo SelectDepartment($conn); ?>
                            </select><br>
                    </div>
